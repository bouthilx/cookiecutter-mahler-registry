# -*- coding: utf-8 -*-
#
# mahler.registry.{{ cookiecutter.plugin_name }} documentation build configuration file.
#
...
import mahler.registry.{{ cookiecutter.plugin_name }} as registry_plugin
...
project = u'mahler.registry.{{ cookiecutter.plugin_name }}'
_full_version = registry_plugin.__version__
copyright = registry_plugin.__copyright__
author = registry_plugin.__author__
...
latex_documents = [
  (master_doc, 'mahler.registry.{{ cookiecutter.plugin_name}}.tex',
   u'Mahler registry {{ cookiecutter.plugin_name }} Documentation',
...
texinfo_documents = [
  (master_doc, '{{ cookiecutter.plugin_name }}',
   u'Mahler registry {{ cookiecutter.plugin_name }} Documentation',
   author, '{{ cookiecutter.plugin_name }}', registry_plugin.__descr__,
   'Miscellaneous'),
]
